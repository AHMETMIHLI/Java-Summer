...
public class Fp05 {
    public static void main(String[] args) {
        ...
        System.out.println("kelimeKursAdlariIcındeVarMi :"+ kelimeKursAdlariIcındeVarMi(coursesList, "Turkish"));
        ortalamaPuaniEnYüksekOlanKursunAdi(coursesList);
    ...
    public static boolean kelimeKursAdlariIcındeVarMi(List<Courses>list, String kelime){
        return list.stream().anyMatch(t->t.getCourseName().contains(kelime));   // kelimeKursAdlariIcındeVarMi :true
    }
    //3) Ortalama puanı en yüksek olan kursu yazdırmak için bir yöntem oluşturun
    public static void ortalamaPuaniEnYüksekOlanKursunAdi(List<Courses>list){
